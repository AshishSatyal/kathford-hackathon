...
const Button = ({ label, link }) => {
  return (
    <a href={link} target='_blank' className="register-btn m-2 relative hidden lg:inline-flex h-12 overflow-hidden rounded-full p-[1.25px] focus:outline-none focus:ring-2 focus:ring-offset transition-all duration-300 ease-out">
