...
const Button = ({ label, link, className }) => {
  return (
    <a href={link} target='_blank' className={`${className} register-btn m-2 relative h-12 overflow-hidden rounded-full p-[1.25px] focus:outline-none transition-all duration-300 ease-out`}>
