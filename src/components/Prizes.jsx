...
const Prizes = () => {
  return (
    <div className='bg-color-4 min-h-[85vh] py-5 lg:px-10'>
      ...
      <div className='p-5 lg:min-w-full'>
        <p className='text-center text-slate-300 font-normal text-xl lg:text-2xl capitalize font-mono tracking-tight mt-5'>
      ...
      <div className='flex flex-col lg:flex-row lg:p-5 items-center justify-center gap-10 mt-5'>
        ...
        />
        <Cards
          bg={"bg-gradient-to-r from-color-2/50 to-color-3/70"}
