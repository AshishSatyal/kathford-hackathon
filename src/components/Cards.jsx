...
const Cards = ({ position, prize, other, img }) => {
  return (
    ...
    >
      ...
      <div className='border cursor-none z-10 border-white/[0.2] flex flex-col items-start max-w-sm mx-auto p-4 relative h-[30rem]'>
        ...
        <h2 className='text-white mt-4 text-2xl font-semibold font-[archiv]'>
          {prize}
        </h2>
        <h2 className='text-white mt-4 text-2xl  font-[archiv]'>{other}</h2>
      </div>
    </motion.div>
  );
};
